...
trainpath=/user/weibo_bigdata_ds/wulei3/shixi_enzhao/warehouse/libsvmfile/sampleData-120Y-10W-903-libsvm/sampleData4KW_12,/user/weibo_bigdata_ds/wulei3/shixi_enzhao/warehouse/libsvmfile/sampleData-120Y-10W-903-libsvm/sampleData4KW_12,/user/weibo_bigdata_ds/wulei3/shixi_enzhao/warehouse/libsvmfile/sampleData-120Y-10W-903-libsvm/sampleData4KW_12
...
config="
   ...
   $TARGET_JAR $trainpath $testpath $iterNum
"
