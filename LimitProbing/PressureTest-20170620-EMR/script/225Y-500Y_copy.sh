...
from_hdfs1=/user/feed_weibo/warehouse/feed_data_v0/dt=20170614
from_hdfs2=/user/feed_weibo/warehouse/feed_data_v0/dt=20170613
from_hdfs3=/user/feed_weibo/warehouse/feed_data_v0/dt=20170612
from_hdfs4=/user/feed_weibo/warehouse/feed_data_v0/dt=20170611
from_hdfs5=/user/feed_weibo/warehouse/feed_data_v0/dt=20170610
from_hdfs6=/user/feed_weibo/warehouse/feed_data_v0/dt=20170609
...
echo ===========================================
cmd="hadoop distcp -m 100 -bandwidth 70 $from_hdfs6 $to_hdfs6"
hadoop fs -ls from_hdfs6
dateBeforeStart=`date +%F_%H-%M-%S`
echo $cmd
# $cmd
dataAfterStart=`date +%F_%H-%M-%S`
